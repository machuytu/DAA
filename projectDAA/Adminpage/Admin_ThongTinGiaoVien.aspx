<%@ Page Language="C#" MasterPageFile="~/Administrator.Master" AutoEventWireup="true" CodeBehind="Admin_ThongTinGiaoVien.aspx.cs" Inherits="projectDAA.Adminpage.Admin_ThongTinGiaoVien" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        InsertCommand="INSERT INTO [giaovien] ([magv], [tengv], [gioitinh], [ngaysinh], 
            [diachi], [quequan], [sdt], [capbac], [email], [ngayvaolam]) 
            VALUES (@magv, @tengv, @gioitinh, @ngaysinh, @diachi, @quequan, @sdt, @capbac, @email, @ngayvaolam)"
        SelectCommand="SELECT * FROM [giaovien]"
        UpdateCommand="UPDATE [giaovien] SET [tengv] = @tengv, [gioitinh] = @gioitinh, [ngaysinh] = @ngaysinh, 
            [diachi] = @diachi, [quequan] = @quequan, [sdt] = @sdt, [capbac] = @capbac, [email] = @email, [ngayvaolam] = @ngayvaolam 
            WHERE [magv] = @magv">
        <DeleteParameters>
            <asp:ControlParameter ControlID="txtmagv" Name="magv" PropertyName="Text" Type="String" />
        </DeleteParameters>
        <UpdateParameters>
    ...
    <br />
    <br />
    <table style="width: 100%; text-align: right; align-content: center">
        <tr>
            <td style="width: 50%">
        ...
        <tr>
            ...
            <td style="text-align: left">
                ...
                <asp:CalendarExtender ID="txtngayvaolam_CalendarExtender" runat="server"
                    Enabled="True" TargetControlID="txtngayvaolam"></asp:CalendarExtender>
        ...
        <tr>
            ...
            <td style="text-align: left">
                ...
                <asp:CalendarExtender ID="txtngaysinh_CalendarExtender" runat="server"
                    Enabled="True" TargetControlID="txtngaysinh"></asp:CalendarExtender>
