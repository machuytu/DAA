<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangNhap.aspx.cs" Inherits="projectDAA.DangNhap" %>
...
<body>
    ...
    <div align="center" style="margin: 80px 50px 10px 50px;">
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/image/logo.png" 
            NavigateUrl="https://www.uit.edu.vn/" ToolTip="Trường Đại học Công nghệ Thông tin">HyperLink</asp:HyperLink>
        <br />
        <br />
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="15pt" 
                    ForeColor="#0066FF" Text="Đăng nhập hệ thống DAA"></asp:Label>
            </td>
        </tr>
        <tr>
